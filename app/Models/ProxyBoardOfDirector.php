...
class ProxyBoardOfDirector extends Model
{
    use SoftDeletes;
    ...
    protected $primaryKey = 'proxyBodId';
    protected $table = 'proxy_board_of_directors';
    ...
    public function cancelledProxyBod()
    {
        return $this->hasMany(ProxyBoardOfDirectorCancelled::class, 'accountId', 'accountId');
    }
}
