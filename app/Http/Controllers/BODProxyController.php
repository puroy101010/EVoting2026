...
class BODProxyController extends Controller
{
    ...
    public function show(ShowBodProxyRequest $request, $id)
    {
        try {
            ...
            AppHelper::logServerError("Error occurred while fetching BOD proxy details for account ID: $id", $e);
    ...
    public function history(Request $request, $id)
    {
        try {
            ...
            if (!Auth::user()->can('view bod proxy history') && !Auth::user()->role !== 'superadmin') {
