...
class AmendmentProxyController extends Controller
{
    ...
    public function show(ShowAmendmentProxyRequest $request, $id)
    {
        try {
            ...
            AppHelper::logServerError('Error occurred while fetching Amendment proxy details', $e, ['account_id' => $id]);
    ...
    public function cancel(CancelProxyAmendmentRequest $request, int $proxyId)
    {
        return $this->amendmentProxyService->cancel($request, $proxyId);
    }
    ...
    public function masterlist(Request $request)
    {
        ...
        if (!Auth::user()->can('view amendment proxy masterlist') && Auth::user()->role !== 'superadmin') {
        ...
        return view('admin.amendment.proxy_amendment_masterlist', [
