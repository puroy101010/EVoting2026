...
class CreateUsedBodAccountsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('used_bod_accounts', function (Blueprint $table) {
            $table->id('usedBodAccountId')->unsignedBigInteger();
    ...
    {
        Schema::dropIfExists('used_bod_accounts');
    }
}
