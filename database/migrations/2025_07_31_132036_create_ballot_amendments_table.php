...
class CreateBallotAmendmentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ballot_amendments', function (Blueprint $table) {
            $table->id('ballotAmendmentId')->unsignedBigInteger();
            $table->unsignedSmallInteger('yes');
            $table->unsignedSmallInteger('no');
            $table->unsignedBigInteger('amendmentId');
    ...
    {
        Schema::dropIfExists('ballot_amendments');
    }
}
