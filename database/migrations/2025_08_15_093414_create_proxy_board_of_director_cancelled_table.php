...
class CreateProxyBoardOfDirectorCancelledTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('proxy_board_of_director_cancelled', function (Blueprint $table) {
            $table->id('proxyBodCancelledId')->unsignedBigInteger();
            $table->string('proxyBodFormNo', 10);
            ...
            $table->unsignedBigInteger('proxyBodId')->unique();
            ...
            // $table->foreign('proxyBodId')->references('proxyBodId')->on('proxy_board_of_director')->onDelete('restrict');
    ...
    {
        Schema::dropIfExists('proxy_board_of_director_cancelled');
    }
}
