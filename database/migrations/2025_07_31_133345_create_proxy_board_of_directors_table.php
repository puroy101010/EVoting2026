...
class CreateProxyBoardOfDirectorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('proxy_board_of_directors', function (Blueprint $table) {
            $table->id('proxyBodId')->unsignedBigInteger();
            $table->string('proxyBodFormNo', 10)->unique();
            $table->unsignedBigInteger('accountId')->unique();
            $table->unsignedBigInteger('assignorId');
            $table->unsignedBigInteger('assigneeId');
            $table->string('assigneeEmail', 100);
            $table->string('assigneeName');
            $table->string('assignorEmail', 100);
    ...
    {
        Schema::dropIfExists('proxy_board_of_directors');
    }
}
