...
class CreateProxyBoardOfDirectorHistoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('proxy_board_of_director_histories', function (Blueprint $table) {
            $table->id('proxyBodHistoryId')->unsignedBigInteger();
    ...
    {
        Schema::dropIfExists('proxy_board_of_director_histories');
    }
}
