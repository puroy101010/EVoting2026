...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        $permissions = [
            ...
            ['permission' => 'view online accounts', 'guard_name' => 'web', 'module' => 'online account', 'description' => 'view online accounts'],
            ...
            ['permission' => 'edit corporate representative', 'guard_name' => 'web', 'module' => 'stockholder', 'description' => 'edit corporate representative'],
            ['permission' => 'edit authorized signatory', 'guard_name' => 'web', 'module' => 'stockholder', 'description' => 'edit authorized signatory'],
