        ...
        <div class="table-responsive" style="height: 750px; overflow: auto;">
          ...
          <table class="table corporate-table ultra-compact" id="proxy_holders_table">
            ...
            <tbody>
              ...
              $withCancelled .= "<a class=\"text-muted btn-proxyholder-history\" data-id=\"{$proxyholder['accountId']}\" data-account-no=\"{$proxyholder['accountNo']}\" data-proxy-type=\"BOD\">(" . implode(' | ', $formNumbers) . ")</a>";
              }
              }
              @endphp
