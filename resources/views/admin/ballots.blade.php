...
<style>
  ...
  .table {
    ...
    overflow: hidden;
    box-shadow: 0 2px 8px rgba(47, 74, 60, 0.07);
  ...
  .table-responsive {
    border-radius: 0.75rem;
    box-shadow: 0 2px 8px rgba(47, 74, 60, 0.04);
    background: #fff;
    margin-bottom: 2rem;
                ...
                <table class="table table-bordered" id="table_ballots">
                  <thead class="text-nowrap table-light" style="position: sticky;top: 0; z-index: 1;">
                    <tr>
                      ...
                      <th class="th-padding">{{ $candidate->firstName . ' ' . $candidate->lastName }}</th>
                      @endforeach
                  ...
                  <tbody>
                    ...
                    foreach ($ballots as $ballot) {
                      ...
                      $status = $ballot['isSubmitted'] === 1 ?
                        '<span class="badge badge-mid-green">Submitted</span>' :
                        '<span class="badge badge-dark-green">Unsubmitted</span>';

                      $revoked = Illuminate\Support\Facades\Auth::user()->role === 'superadmin' ? $ballot['revoked'] : '-'; // only superadmin can see revoked status
