...
<style type="text/css">
  ...
  #filter_box .div-align {
    margin-top: 0.25rem !important;
    margin-bottom: 0 !important;
  }

  #filter_box .div-align button {
    padding: 0.2rem 0.4rem !important;
    font-size: 0.7rem !important;
  }

  #filter_box .pagination {
    margin: 0.25rem 0 0 0 !important;
    font-size: 0.8rem !important;
  }

  #filter_box .pagination .page-link {
    padding: 0.25rem 0.4rem !important;
  }

  #filter_box .record-summary {
    margin: 0 !important;
    font-size: 0.7rem !important;
              ...
              <div class="card-body pl-2 pr-2 mb-2" style="border: 1px solid #dec8c8; border-radius: 5px; background-color: #f5f5f5; display: none " id="filter_box">
                <form id="filter_form">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-md-2 div-text div-text-right offset-md-4">Go to Page</div>
                    <div class="col-md-2 col-md2-size">
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="dflex-button">
                      <button class="btn btn-sm border-secondary" type="button" id="show_filter" data-visible="false">Show Filter</button>
                ...
                <table id="memberTable" class="table corporate-table ultra-compact">
                  <thead class="text-nowrap" style="position: sticky; top: 0; z-index: 1; background-color: #27ae60;">
                    <tr style="background-color: #27ae60; color: white;">
                      ...
                      <th class="th-padding text-center" colspan="2">Action</th>
                    </tr>
                  </thead>
                  <tbody>
                  </tbody>
                ...
                <div class="corporate-form-group ultra-compact">
                  ...
                  <div class="corporate-input-group">
                    ...
                    <input type="email" id="email" class="corporate-input compact"
                      name="email" placeholder="Enter email address" autocomplete="off" disabled>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="corporate-form-group ultra-compact">
                  ...
                  <div class="corporate-input-group">
                    ...
                    <input type="text" id="auth_signatory" class="corporate-input compact"
                      name="auth_signatory" placeholder="Enter authorized signatory name" autocomplete="off" disabled>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="corporate-form-group ultra-compact">
                  ...
                  <div class="corporate-input-group">
                    ...
                    <input type="email" id="corp_rep_email" class="corporate-input compact"
                      name="corp_rep_email" placeholder="Enter representative email" autocomplete="off" disabled>
                  </div>
                </div>
              </div>
            </div>
  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content corporate-modal-content">
      ...
      <form id="form_edit_member">
        ...
        <div class="modal-body corporate-modal-body ultra-compact">
          <!-- Stockholder Details Section -->
          <div class="corporate-section-card ultra-compact mb-4" id="edit_stockholder_details_section" style="display: none;">
            <div class="corporate-section-header">
              <h5 class="corporate-section-title" id="edit_stockholder_details_title">
                <i class="fas fa-id-card mr-2"></i>Stockholder Details
              </h5>
            </div>
            <div class="row">
                ...
                <div class="corporate-form-group ultra-compact">
                  ...
                  <div class="corporate-input-group">
                    ...
                    <input type="text" id="edit_account_number" class="corporate-input compact"
                      name="account_number" placeholder="Enter account number" autocomplete="off" maxlength="4" minlength="4">
                  </div>
                </div>
              </div>
                ...
                <div class="corporate-form-group ultra-compact">
                  ...
                  <div class="corporate-input-group">
                    ...
                    <input type="text" id="edit_stockholder" class="corporate-input compact"
                      name="stockholder" placeholder="Enter stockholder name" autocomplete="off">
                  </div>
                </div>
              </div>
            </div>
...
<!-- AUTH SIGNATORY MODAL - Modern Design -->
<div class="modal fade" id="authSignatoryModal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content corporate-modal-content">
      <!-- Modal Header -->
      <div class="modal-header corporate-modal-header ultra-compact">
        <h4 class="modal-title corporate-modal-title ultra-compact">
          <i class="fas fa-pen mr-2"></i>Update Authorized Signatory
        </h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      ...
      <form id="form_auth_signatory">
        ...
        <div class="modal-body corporate-modal-body ultra-compact">
          <div class="corporate-section-card ultra-compact">
            <div class="corporate-section-header">
              <h5 class="corporate-section-title" id="auth_sig_stockholder_text">
              </h5>
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="corporate-form-group ultra-compact">
                  <label for="auth_sig_name" class="corporate-label ultra-compact">
                    Authorized Signatory Name <span class="text-danger">*</span>
                  </label>
                  <div class="corporate-input-group">
                    <div class="corporate-input-icon compact">
                      <i class="fas fa-user"></i>
                    </div>
                    <input type="text" id="auth_sig_name" class="corporate-input compact"
                      name="auth_signatory" placeholder="Enter authorized signatory name"
                      autocomplete="off">
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="corporate-form-group ultra-compact">
                  <label for="auth_sig_email" class="corporate-label ultra-compact">
                    Email Address
                  </label>
                  <div class="corporate-input-group">
                    <div class="corporate-input-icon compact">
                    ...
                    <input type="email" id="auth_sig_email" class="corporate-input compact" name="auth_signatory_email" placeholder="Enter email address" autocomplete="off">
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="modal-footer corporate-modal-footer ultra-compact">
          ...
          <button type="submit" class="btn corporate-btn-primary ultra-compact btn-submit-form" id="btn_submit_auth_signatory">
            <i class="fas fa-save mr-1"></i> Update Authorized Signatory
          </button>
          <span class="spinner-border corporate-spinner submit-loading" role="status" style="display: none"></span>
        </div>
      </form>
...
<!-- END AUTH SIGNATORY MODAL -->

<!-- CORPORATE REP MODAL - Modern Design -->
<div class="modal fade" id="corpRepModal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content corporate-modal-content">
      <!-- Modal Header -->
      <div class="modal-header corporate-modal-header ultra-compact">
        <h4 class="modal-title corporate-modal-title ultra-compact">
          <i class="fas fa-pen mr-2"></i>Update Corporate Representative
        </h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      ...
      <form id="form_corp_rep">
        ...
        <div class="modal-body corporate-modal-body ultra-compact">
          <div class="corporate-section-card ultra-compact">
            <div class="corporate-section-header">
              <h5 class="corporate-section-title" id="corp_rep_stockholder_text">
                <i class="fas fa-pen mr-2"></i>Corporate Representative Details
              </h5>
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="corporate-form-group ultra-compact">
                  <label for="corp_rep_name" class="corporate-label ultra-compact">
                  ...
                  <div class="corporate-input-group">
                    ...
                    <input type="text" id="corp_rep_name" class="corporate-input compact"
                      name="corp_rep" placeholder="Enter corporate representative name"
                      autocomplete="off">
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="corporate-form-group ultra-compact">
                  ...
                  <div class="corporate-input-group">
                    ...
                    <input type="email" id="corp_rep_email" class="corporate-input compact"
                      name="corp_rep_email" placeholder="Enter corporate email" autocomplete="off">
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="modal-footer corporate-modal-footer ultra-compact">
          ...
          <button type="submit" class="btn corporate-btn-primary ultra-compact btn-submit-form" id="btn_submit_corp_rep">
            <i class="fas fa-save mr-1"></i> Update Corporate Rep
          </button>
          <span class="spinner-border corporate-spinner submit-loading" role="status" style="display: none"></span>
        </div>
      </form>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content corporate-modal-content">
      ...
      <form id="assignProxyFormAmendment">
        ...
        <div class="modal-body corporate-modal-body ultra-compact pb-5">
          <div class="assign-stock-form">
            <div class="corporate-section-card ultra-compact mb-4">
              <div class="corporate-section-header">
                <h5 class="corporate-section-title">
              ...
              <div class="row mt-2">
                <div class="col-md-6">
                  <div class="corporate-form-group ultra-compact">
                    ...
                    <input type="text" name="refNo" class="corporate-input compact" placeholder="Enter reference number" maxlength="12">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="corporate-form-group ultra-compact">
        ...
        <div class="modal-footer corporate-modal-footer ultra-compact">
          ...
          <button type="button" class="btn corporate-btn-danger ultra-compact assignee-details" data-proxy-id="" id="btnCancelAmendmentProxy" onclick="cancelAmendmentProxy(this)">Cancel Proxy</button>
...
<script>
  const editMemberUrl = "{{ route('stockholder.edit', ['stockholder' => ':stockholder']) }}";
