...
<head>
  ...
  <script src="{{ asset('js/e-voting/app.js') }}?v={{ @filemtime(public_path('js/e-voting/app.js')) ?: time() }}" defer></script>
  <script src="{{ asset('js/jquery-3.5.1.js') }}?v={{ time() }}"></script>
  ...
  <!-- Chosen -->
  <link href="{{asset('css/chosen.mod.css')}}?v={{ time() }}" rel="stylesheet">
  <link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
  <script src="{{ asset('js/chosen.jquery.min.js') }}?v={{ time() }}" defer></script>


  <!-- Styles -->
  <link href="{{ asset('css/app.css') }}?v={{ time() }}" rel="stylesheet">
  <link href="{{ asset('css/e-voting/app.css') }}?v={{ @filemtime(public_path('css/e-voting/app.css')) ?: time() }}" rel="stylesheet">

  <script src="{{ asset('js/sweetalert2@9.js') }}?v={{ time() }}"></script>
  ...
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="{{asset('plugins/overlayScrollbars/css/OverlayScrollbars.min.css')}}?v={{ @filemtime(public_path('plugins/overlayScrollbars/css/OverlayScrollbars.min.css')) ?: time() }}">
  <!-- Theme style -->
  <link rel="stylesheet" href="{{asset('dist/css/adminlte.min.css')}}?v={{ @filemtime(public_path('dist/css/adminlte.min.css')) ?: time() }}">

  <link rel="stylesheet" href="{{asset('css/admin/customize.css')}}?v={{ @filemtime(public_path('css/admin/customize.css')) ?: time() }}">
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-green elevation-4">
      <a href="{{asset('admin')}}" class="brand-link d-flex align-items-center justify-content-center">
        ...
        <span class="brand-text font-weight-bold">Online Voting System</span>
      </a>
      <div class="sidebar">
  ...
  <!-- overlayScrollbars -->
  <script src="{{asset('plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js')}}?v={{ @filemtime(public_path('plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js')) ?: time() }}"></script>


  <!-- AdminLTE App -->
  <script src="{{asset('dist/js/adminlte.js')}}?v={{ @filemtime(public_path('dist/js/adminlte.js')) ?: time() }}"></script>
