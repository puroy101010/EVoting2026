    ...
    <div class="modal-content">
      <div class="modal-header">
        <div>
          ...
          <small class="text-white-50">Proxy Voting</small>
        </div>
...
<script>
  // ==================================================
  // BALLOT VOTING SYSTEM - PROXY VOTING  FORM
  // ==================================================
    ...
    async submitBallotData() {
      try {
        ...
        const serverResponse = await $.ajax({
          url: BASE_URL + 'user/ballot/proxy-voting/submit',
          method: 'POST',
          dataType: 'json',
    ...
    async generateBallotSummary() {
      try {
        const response = await $.ajax({
          url: BASE_URL + `user/ballot/proxy-voting/${BALLOT_CONFIG.ballotId}/summary`,
          method: 'POST',
          dataType: 'json',
          data: {
            ballotId: BALLOT_CONFIG.ballotId,
